...
export default {
  async fetch(request) {
    ...
    const CHANNELS = {
      ...
      'Orbit-starsports2hd': {
        url: 'http://172.19.17.3:8090/hls/StarSports2HD.m3u8',
        type: 'redirect'
      },
      'Orbit-sonyten5hd': {
        url: 'http://172.19.17.3:8090/hls/SonyTen5HD.m3u8',
        type: 'redirect'
      },
      'Orbit-sonyten2hd': {
      ...
      'Orbit-beinSports1eng': {
        url: 'http://172.19.17.3:8090/hls/BeinSports1ENG.m3u8',
        type: 'redirect'
      },
      'Orbit-sangeetbangla': {
        url: 'http://172.19.17.3:8090/hls/SangeetBangla.m3u8',
        type: 'redirect'
      },
      'Orbit-9xm': {
        url: 'http://172.19.17.3:8090/hls/9xm.m3u8',
        type: 'redirect'
      },
      'Orbit-Discoverykids': {
        url: 'http://172.19.17.3:8090/hls/DiscoveryKids.m3u8',
        type: 'redirect'
      },
      'Orbit-Cartoonnetwork': {
        url: 'http://172.19.17.3:8090/hls/CartoonNetworkHD.m3u8',
        type: 'redirect'
      },
      'Orbit-starmovieshd': {
        url: 'http://172.19.17.3:8090/hls/StarMoviesHD.m3u8',
        type: 'redirect'
      },
      'Orbit-discoveryhd': {
        url: 'http://172.19.17.3:8090/hls/DiscoveryHD.m3u8',
        type: 'redirect'
      },
      'Orbit-natgeowild': {
